...
exports.getNewsHeadlines = void 0;
const newsHeadline_1 = require("../../models/newsHeadline");
const base_1 = __importDefault(require("../../db/base"));
(0, base_1.default)();
const getNewsHeadlines = (parent, args, contextValue) => __awaiter(void 0, void 0, void 0, function* () {
    if (contextValue.user === "unauthorized") {
        return [];
    }
    const getNewsHeadline = yield newsHeadline_1.NewsHeadline.find();
